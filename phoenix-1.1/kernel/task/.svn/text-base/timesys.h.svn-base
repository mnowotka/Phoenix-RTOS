...
extern int timesys_init(uint_t slice);
 ...
 */
extern void sleep_unintr(uint_t delay);
 ...
 * signals.
 */
extern void sleep_on_unintr(uint_t delay, uint_t *var, uint_t val);
 ...
 */
extern void sleep_on(uint_t delay, uint_t *var, uint_t val);
